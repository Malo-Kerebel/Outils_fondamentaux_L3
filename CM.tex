...
Si \(T_1, T_2 \in \ens{D}\) :
\[
	\langle T_1 + T_2, \varphi \rangle = \langle T_1, \varphi \rangle + \langle T_2, \varphi \rangle \forall \varphi \in \ens{D}
...
\[
	T_1 = T_2 text{dans} \ens{D}' \Leftrightarrow T_1 - T_2 = 0 \text{dans} \ens{D}'
\]
C'est à dire :
\[
